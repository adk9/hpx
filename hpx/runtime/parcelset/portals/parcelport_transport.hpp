...
#if !defined(HPX_PARCELSET_PORTALS_PARCELPORT_TRANSPORT_HPP)
#define HPX_PARCELSET_PORTALS_PARCELPORT_TRANSPORT_HPP
...
namespace hpx { namespace parcelset { namespace portals
{
    ...
    public:
            ...
            Handler handler, ParcelPostprocess parcel_postprocess)
        {
            ...
            // std::cerr << "out_priority=" << out_priority_ << std::endl;
            // std::cerr << "out_size=" << out_size_ << std::endl;
            // std::cerr << "out_data_size=" << out_data_size_ << std::endl;
            // std::copy(out_buffer_.begin(), out_buffer_.end(), std::ostream_iterator<char>(std::cerr, ""));
            // std::cerr << std::endl;
    ...
    private:
        ...
        parcelset::portals::parcelport& parcelport_;
